...
| | Wat er misging | |
|---|---|---|
| **Kaart per positie** | **Een gedeelde kaart voor één positie — een plaatje van hoe die ene aandeel of belegging het deed, om te delen — begon bij de eerste transactie van je hele rekening, niet bij de eerste keer dat je díe positie kocht.** Kocht je iets pas jaren later, dan liet de kaart een vlakke lijn zien van vóór je de positie überhaupt had, alsof hij al die tijd open stond. Hij begint nu bij de eerste aankoop van díe positie. Het percentage veranderde niet: elke dag vóór je iets had, telde toch al voor nul mee — alleen de vlakke lijn ervoor en de datum op de kaart klopten niet. | `0.44.2` |
