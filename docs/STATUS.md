...
| US-35d | **Optimism Mode: a new chart rather than a deformed one** — *Upside remaining* and *Conviction index*, both true read straight. Prototype at `docs/prototypes/optimism-flip.html` | One or both, beside or instead. Then build |
